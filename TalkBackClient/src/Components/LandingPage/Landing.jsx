            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6} md={4} lg={6}>
                <Typography>
                  ...
                  transform the way you connect and communicate with others.
                  With a sleek and intuitive interface, our app offers a
                  seamless chatting experience that caters to your every need.
                  Whether you're keeping in touch with friends, collaborating
                  with colleagues, or meeting new people, our platform provides
                  the perfect environment for meaningful conversations. Packed
                  with innovative features such as encrypted messaging,
                  customizable themes, and real-time translation, our app
                  ensures privacy, personalization, and accessibility. Join the
                  millions of users already enjoying the convenience and
                  versatility of our chat messaging app, and discover a new
